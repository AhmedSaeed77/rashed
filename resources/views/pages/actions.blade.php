                        ...
                        <div class="section-all">
                            ...
                            <div class="item3">
                                <article class="inner-box hvr-float-shadow pb-30">
                                    <figure class="image">
                                        <a href="{{ route('singleaction', ['id'=>$action->id]) }}">
                                            <img src="{{ asset('public/storage/'.$action->img) }}" alt="">
                                        </a>
                                    </figure>
                                    <div class="post-lower">
                                        ...
                                        <div class="post-desc">
                                            ...
                                            <div class="text-right">
                                                <a href="{{ route('singleaction', ['id'=>$action->id]) }}" class="text-thm fs-14"> @lang('site.more') <i class="fa fa-caret-right"></i></a>
                                            </div>
                                        </div>
                                    </div>
                                </article>
